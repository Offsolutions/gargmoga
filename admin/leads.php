...
<div class="row small-spacing">
	<div class="col-lg-4">
		<div class="box-content">
			...
			<form data-toggle="validator" role="form" action="action.php" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="page" value="leads.php">
	...
	<div class="col-lg-8">
		<div class="box-content">
			<h4 class="box-title">Professional Leads</h4>
			<table id="myTable1" class="table table-hover table-striped display  table-bordered  pb-30">
				...
				<tbody>
					...
					$record = $obj->selectDataAll("team", $where_page);
					if ($record) {
						$sr = 0;
					...
					?>
							...
							<tr>
								...
								<td class="text-nowrap">
									...
									<a href="leads.php?id=<?php echo $row["id"]; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i style="font-size:20px;" class="fa fa-pencil text-inverse m-r-10"></i> </a>
...
<script>
	function confirm(id) {
		...
		swal({
			...
			window.location.href = "action.php?page=leads.php&del_team=" + id;
		});
		return false;
