		...
		<div class="box-content">
			...
			?>
				...
				<form action="action.php" method="post" enctype="multipart/form-data">
					...
					<button type="submit" name="edit_wcu" value="edit_wcu" class="btn btn-primary btn-anim"><i class="icon-rocket"></i><span class="btn-text">Update</span></button>
				</form>
			<?php
			} else {
				echo "";
