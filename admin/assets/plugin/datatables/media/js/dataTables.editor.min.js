...
c=this["c"]["classPrefix"]+("-"+"t"+"abl"+"e");this["c"][("sho"+"w"+"W"+"e"+"ek"+"Nu"+"m"+"ber")]&&(c=c+(" "+"w"+"eek"+"Number"));return '<table class="'+c+'"><thead class="text text-dark">'+this["_htmlMonthHead"]()+("</"+"t"+"he"+"a"+"d"+"><"+"t"+"bo"+"d"+"y"+">")+g["join"]("")+("</"+"t"+"bo"+"d"+"y"+"></"+"t"+"a"+"ble"+">");}
