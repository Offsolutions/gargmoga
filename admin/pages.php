	...
	<div class="col-lg-12">
		<div class="box-content">
			<div class="pull-right">
				<a href="add_page.php" class="btn btn-primary">Add</a>
			</div>
					...
					?>
							<tr>
								...
								<td class="text-nowrap">
									<a href="add_page.php?id=<?php echo $row['id']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i style="font-size:20px;" class="fa fa-pencil text-inverse m-r-10"></i> </a>
...
<script>
	function confirm(id) {
		...
		swal({
			...
			window.location.href = "action.php?del_page=" + id;
		});
		return false;
