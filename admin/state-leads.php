...
<div class="row small-spacing">
	<div class="col-lg-4">
		<div class="box-content">
			...
			<form data-toggle="validator" role="form" action="action.php" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="page" value="state-leads.php">
	...
	<div class="col-lg-8">
		<div class="box-content">
			<h4 class="box-title">State Leads</h4>
					...
					?>
							...
							<tr>
								...
								<td class="text-nowrap">
									...
									<a href="state-leads.php?id=<?php echo $row["id"]; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i style="font-size:20px;" class="fa fa-pencil text-inverse m-r-10"></i> </a>
...
<script>
	function confirm(id) {
		...
		swal({
			...
			window.location.href = "action.php?page=state-leads.php&del_team=" + id;
		});
		return false;
