...
<div class="row small-spacing">
    <div class="col-lg-4">
        <div class="box-content">
            ...
            <h4>Add/Edit Banners</h4>
            <?php
			if (isset($_GET["id"])) {
				$where = array(
					"id" => $_GET["id"],
				);
				$row1 = $obj->selectData("banners", $where);
			}
			?>
            <form data-toggle="validator" role="form" action="action.php" method="post" enctype="multipart/form-data">
                ...
                <div class="">
                    <div class="form-group mb-30">
                        ...
                        <input type="file" id="input-file-now-custom-1" class="dropify"
                            <?php if (isset($row1["img"])) { ?>
                            data-default-file="../images/<?php echo isset($row1["img"]) ? $row1["img"] : ""; ?>"
                            <?php } ?> name="img">
                        <span class="text text-center">1920*1280</span>
                    </div>
                </div>
                <div style="margin-top: 10px;" class="box-content">
                    <h4 class="box-title">Description</h4>
                    <textarea required name="title" id="tinymce">
							<?php echo isset($row1["title"]) ? $row1["title"] : ""; ?>
					</textarea>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" name="<?php echo $act; ?>" value="<?php echo $act; ?>"
                        class="btn btn-primary btn-anim"><i class="icon-rocket"></i><span
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            ...
                            <a href="banners.php?id=<?php echo $row["id"]; ?>" class="mr-25" data-toggle="tooltip"
...
function confirm(id) {
    ...
    swal({
        ...
        window.location.href = "action.php?del_banners=" + id;
    });
    return false;
